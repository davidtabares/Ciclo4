...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String firstName = myPreferences.getString("firstName", "");
        String image = myPreferences.getString("image", "");

        if (!user.equals("") && !password.equals("")) {
            toLogin(user, password, firstName, image);
        }
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        String userImage = document.getData().get("image").toString();

                        if (password.equals(userPassword)) {
                            toLogin(email, password, userFirstName, userImage);
                        } else {
    ...
    public void toLogin(String user, String password, String firstName, String image){
