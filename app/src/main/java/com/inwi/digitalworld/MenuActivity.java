...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user = myPreferences.getString("user", getResources().getString(R.string.txt_no_user));
        String password = myPreferences.getString("password", getResources().getString(R.string.txt_no_password));
        String firstName = myPreferences.getString("firstName", "No Name");
        String image = myPreferences.getString("image", "");

        View headerView = navigationView.getHeaderView(0);
        TextView navName = headerView.findViewById(R.id.tev_header_name);
        TextView navEmail= headerView.findViewById(R.id.tev_header_email);

        navImage = headerView.findViewById(R.id.imv_header_image);
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == OPEN_GALLERY) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(myActivity, getResources().getString(R.string.txt_product_image_error), Toast.LENGTH_SHORT).show();
            }
        }
            ...
            riversRef.putFile(data1)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            ...
                            Toast.makeText(myActivity, exception.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    });
        }
